      ...
      <div class="row g-4">
        ...
        <div class="col-md-6">
          ...
          <div class="card card-primary card-outline mb-4">
            <!--begin::Header-->
            <div class="card-header"><div class="card-title">Modifier Mot de Passe</div></div>
            <!--end::Header-->
            ...
            <form method="post" action="{{ route('admin.update-password.request') }}">@csrf 
              ...
              <div class="card-body">
                  <div class="mb-3"> 
                      ...
                      <input type="email" class="form-control" id="email" aria-describedby="emailHelp" value="{{ Auth::guard('admin')->user()->email }}" readonly style="background-color: #ccc;">
                      <div id="emailHelp" class="form-text">
                          Nous ne partagerons jamais votre e-mail avec personne d'autre.
                      </div>
                  </div>
                  <div class="mb-3"> 
                      <label for="current_pwd" class="form-label">Mot de passe actuel</label> 
                      <input type="password" class="form-control" id="current_pwd" name="current_pwd">
                      <span id="verifyPwd"></span>
                  </div>
                  <div class="mb-3"> 
                      <label for="new_pwd" class="form-label">Nouveau mot de passe</label> 
