        ...
        <div class="col-md-8">
          ...
          <div class="card card-primary card-outline mb-4">
            ...
            <!--end::Header-->
              ...
              @endforeach
            <!--begin::Form-->
                  <form name="productForm" id="productForm" action="{{ isset($product) ? route('products.update', $product->id) : route('products.store') }}" method="post">@csrf
                  ...
                  <label for="category_id">Category Level (Select Category)*</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="product_color" class="form-control" value="{{ old('product_color', $product->product_color ?? '') }}" placeholder="Enter Product Color">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="group_code" class="form-control" value="{{ old('group_code', $product->group_code ?? '') }}" placeholder="Enter Group Code">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="product_discount" class="form-control" value="{{ old('product_discount', $product->product_discount ?? '') }}">
                    </div>
            
                    <div class="mb-3">
                        <label class="form-label" for="product_gst">Product GST (%)</label>
                        <input type="number" step="0.01" name="product_gst" class="form-control" value="{{ old('product_gst', $product->product_gst ?? '') }}">
                    </div>
            
                    <div class="mb-3">
                        <label class="form-label" for="product_weight">Product Weight (grams)</label>
                        <input type="number" step="0.01" name="product_weight" class="form-control" value="{{ old('product_weight', $product->product_weight ?? '') }}">
                    </div>
                                ...
                                <table class="table table-bordered align-middle mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>{{ $attribute['sku'] }}</td>
                                            <td>
                                                <input type="number" name="update_price[]" value="{{ $attribute['price'] }}"
                    ...
                    <div class="mb-3">
                          ...
                          @if(!empty($product['main_image']))
                            <a target="_blank" href="{{ url('front/images/products/'.$product['main_image']) }}">
                              <img style="width:50px; margin: 10px;" src="{{ url('product-image/thumbnail/' . $product->main_image) }}"></a><a style='color:#3f6ed3;' class="confirmDelete" title="Delete Product Image" href="javascript:void(0)" data-module="product-main-image" data-id="{{ $product['id'] }}"><i class="fas fa-trash"></i></a>
                          @endif
                     </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="sort" class="form-control" value="{{ old('sort', $product->sort ?? '') }}">
                    </div>
