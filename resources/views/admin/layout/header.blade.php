<nav class="app-header navbar navbar-expand bg-body">
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"><a href="{{ url('/') }}" class="nav-link">Retour à la boutique</a>
    </li>
        </ul>
            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <li class="user-header text-bg-primary">
                        <img
                            @if(!empty(Auth::guard('admin')->user()->image))   
                            src="{{ asset('admin/images/photos/'.Auth::guard('admin')->user()->image) }}" @else src="{{ asset('admin/images/user2-160x160.jpg') }}" @endif
                    ...
                    <li class="user-footer">
                        ...
                        <a href="{{ url('admin/logout') }}" class="btn btn-default btn-flat float-end">Déconnexion</a>
                    </li>
                    <!--end::Menu Footer-->
                </ul>
            </li>
